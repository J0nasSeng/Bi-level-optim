...
class GRUNet(nn.Module):
    def __init__(self, hidden_size, output_size, num_layers=1, fft_compression=1, window_size=6, overlap=0.5):
...
model = GRUNet(hidden_size, output_size, num_layers).to(device)
